...
/*
AdvertisementMonitorManager1 BlueZ D-Bus AdvertisementMonitorManager API documentation
*/
...
type AdvertisementMonitorManager1Properties struct {
	...
	/*
		SupportedFeatures This lists the features of advertisement monitoring supported by
		**bluetoothd(8)**.
	...
	*/
	...
	/*
		SupportedMonitorTypes This lists the supported types of advertisement monitors. An application
...
/*
RegisterMonitor Registers the root path of a hierarchy of advertisement monitors
...
/*
UnregisterMonitor Unregisters a hierarchy of advertisement monitors that has been
