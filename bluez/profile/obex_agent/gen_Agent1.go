...
/*
Agent1 BlueZ D-Bus OBEX Agent API documentation
*/
type Agent1 struct {
	client                 *bluez.Client
...
/*
Release This method gets called when **obexd(8)** daemon unregisters the agent.
...
/*
AuthorizePush This method gets called when the **obexd(8)** needs to accept/reject a
