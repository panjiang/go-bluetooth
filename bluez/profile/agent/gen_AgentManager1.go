...
/*
AgentManager1 BlueZ D-Bus AgentManager API documentation
*/
...
/*
RegisterAgent Registers pairing agent.
...
/*
UnregisterAgent Unregisters an agent that has been previously registered using
...
/*
RequestDefaultAgent Requests to make the application agent the default agent. The
