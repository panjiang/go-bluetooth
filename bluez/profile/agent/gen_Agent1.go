...
/*
Agent1 BlueZ D-Bus Agent API documentation
*/
type Agent1 struct {
	client                 *bluez.Client
...
/*
Release This method gets called when the service daemon unregisters the agent.
...
/*
RequestPinCode This method gets called when the service daemon needs to get the passkey
...
/*
DisplayPinCode This method gets called when the service daemon needs to display a
...
/*
RequestPasskey This method gets called when the service daemon needs to get the passkey
...
/*
DisplayPasskey This method gets called when the service daemon needs to display a
...
/*
RequestConfirmation This method gets called when the service daemon needs to confirm a
...
/*
RequestAuthorization This method gets called to request the user to authorize an incoming
...
/*
AuthorizeService This method gets called when the service daemon needs to authorize a
...
/*
Cancel This method gets called to indicate that the agent request failed before
*/
