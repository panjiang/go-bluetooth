...
/*
Media1 BlueZ D-Bus Media API documentation
*/
type Media1 struct {
	client                 *bluez.Client
...
type Media1Properties struct {
	...
	/*
		SupportedUUIDs List of 128-bit UUIDs that represents the supported Endpoint
		registration.
	*/
...
/*
RegisterEndpoint Register a local end point to sender, the sender can register as many
...
/*
RegisterPlayer Register a media player object to sender, the sender can register as
...
/*
RegisterApplication Register endpoints an player objects within root object which must
...
/*
UnregisterApplication This unregisters the services that has been previously registered. The
