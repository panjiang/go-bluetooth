...
/*
Adapter1 BlueZ D-Bus Adapter API documentation
*/
...
type Adapter1Properties struct {
	...
	*/
	...
	/*
		AddressType The Bluetooth Address Type. For dual-mode and BR/EDR only adapter this
	...
	*/
	...
	/*
		Alias The Bluetooth friendly name. This value can be changed.
	...
	*/
	...
	/*
		Discoverable Switch an adapter to discoverable or non-discoverable to either make it
	...
	*/
	...
	/*
		DiscoverableTimeout The discoverable timeout in seconds. A value of zero means that the
	...
	*/
	...
	/*
		ExperimentalFeatures List of 128-bit UUIDs that represents the experimental features
		currently enabled.
	*/
	ExperimentalFeatures []string

	/*
		Manufacturer The manufacturer of the device, as a uint16 company identifier defined
		by the Core Bluetooth Specification.
	*/
	Manufacturer uint16

	/*
		Modalias Local Device ID information in modalias format used by the kernel and
		udev.
	*/
	Modalias string
	...
	*/
	...
	/*
		Pairable Switch an adapter to pairable or non-pairable. This is a global setting
	...
	*/
	...
	/*
		PairableTimeout The pairable timeout in seconds. A value of zero means that the timeout
	...
	*/
	...
	/*
		Powered Switch an adapter on or off. This will also set the appropriate
	...
	*/
	...
	/*
		UUIDs List of 128-bit UUIDs that represents the available local services.
	*/
	UUIDs []string

	/*
		Version The Bluetooth version supported by the device, as a core version code
...
// GetManufacturer get Manufacturer value
func (a *Adapter1) GetManufacturer() (uint16, error) {
	v, err := a.GetProperty("Manufacturer")
	if err != nil {
		return uint16(0), err
	}
...
// GetVersion get Version value
func (a *Adapter1) GetVersion() (byte, error) {
	v, err := a.GetProperty("Version")
	if err != nil {
		return byte(0), err
	}
...
/*
StartDiscovery Starts device discovery session which may include starting an inquiry
...
/*
StopDiscovery Stops device discovery session started by **StartDiscovery**.
...
/*
RemoveDevice Removes the remote device object at the given path including cahed
...
/*
SetDiscoveryFilter Sets the device discovery filter for the caller. When this method is
...
/*
GetDiscoveryFilters Returns available filters that can be given to **SetDiscoveryFilter**.
...
/*
ConnectDevice connects to device without need of performing General Discovery.
